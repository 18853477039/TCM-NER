...
class CausalCollatorForTrain(BaseCollator):
    def __init__(self, tokenizer, input_max_length, output_max_length, model_type):
        super().__init__(tokenizer, input_max_length, output_max_length, model_type)
...
class CausalCollatorForEvaluate(BaseCollator):
    def __init__(self, tokenizer, input_max_length, output_max_length,model_type='glm3'):
        super().__init__(tokenizer,input_max_length, output_max_length,model_type)
